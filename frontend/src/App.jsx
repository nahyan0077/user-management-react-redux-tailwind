...
function App() {
  ...
  console.log("selectorrrrr",userData);
    ...
    <>
      <Router>
        <Routes>
          ...
          <Route path='/home' element={ userData?.role == 'user' ? <Home/> : <SignIn/> } />
          ...
          <Route path='/profile' element={ userData?.role == "user" ? <Profiile/> : <Navigate to="/signin" /> } />
          <Route path='/security' element={ userData?.role == "user" ? <Security/> : <Navigate to="/signin" /> } />
        </Routes>
      </Router>
